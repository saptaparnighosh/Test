...
par(mfrow = c(1,2))
boxplot(strength$age ~ strength$txt, xlab = "Intervention group", ylab = "Age, y", las = 1, main = "Variation of age in both treatment groups")
boxplot(strength$str ~ strength$txt, xlab = "Intervention group", ylab = "Strength", las = 1, main = "Variation of strength in both treatment groups")
par(mfrow = c(1,1))

plot(strength$age, strength$str, xlab = "Age, y", ylab = "Strength", main = "Variation of strength with age", las = 1, col = strength$txt+1, pch = 16, cex = 2)
...
plot(strength$age, strength$str, xlab = "Age, y", ylab = "Strength", main = "Variation of strength with age", las = 1, pch = 16, cex = 2)
...
## Strength decreases with increase of age irrespective of the treatment group. However, a person in the intervention group
## has higher strength than a person in the control group when matched for age.